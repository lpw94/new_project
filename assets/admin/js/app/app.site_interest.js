...
define(function (require, exports) {
    ...
    exports.setInterest = function () {
        ...
        $('.upBtn').click(function (e) {
            ...
            // api request
            base.requestApi('/admin/api/site/getInterest', {'id': id}, function (res) {
                if (res.result == 1) {
        ...
        function save() {
            $('#catPopup .saveBtn').click(function (e) {
                ...
                // api request
                base.requestApi('/admin/api/site/saveInterest', {'data': data, id: id}, function (res) {
                    if (res.result == 1) {
