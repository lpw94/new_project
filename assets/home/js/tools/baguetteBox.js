...
var baguetteBox = (function() {
    ...
    function run(selector, userOptions) {
        buildOverlay();
        //alert(1)
        // For each gallery live a click event to every image inside it
            ...
            function (galleryElement, galleryIndex) {
                ...
                [].forEach.call(
                    ...
                    function (imageElement, imageIndex) {
                        live(imageElement, 'click', function(event) {
                           // alert(2)
                            /*jshint -W030 */
    ...
    function liveEvents() {
        ...
        live(overlay, 'click', function(event) {
            if(event.target && event.target.nodeName !== "IMG")
                hideOverlay();
        });
        // Add event listeners for buttons
        live(document.getElementById('previous-button'), 'click', function(event) {
            /*jshint -W030 */
            event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true;
            showPreviousImage();
        });
        live(document.getElementById('next-button'), 'click', function(event) {
            /*jshint -W030 */
            event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true;
            showNextImage();
        });
        live(document.getElementById('close-button'), 'click', function(event) {
            /*jshint -W030 */
            event.stopPropagation ? event.stopPropagation() : event.cancelBubble = true;
            hideOverlay();
        });
        // Add touch events
        live(overlay, 'touchstart', function(event) {
            // Save x axis position
            touchStartX = event.changedTouches[0].pageX;
        });
        live(overlay, 'touchmove', function(event) {
            if(touchFlag)
                return;
            /*jshint -W030 */
            event.preventDefault ? event.preventDefault() : event.returnValue = false;
        ...
        live(overlay, 'touchend', function(event) {
            touchFlag = false;
        });
        // Activate keyboard shortcuts
        live(document, 'keydown', function(event) {
    ...
    function live(element, event, callback) {
